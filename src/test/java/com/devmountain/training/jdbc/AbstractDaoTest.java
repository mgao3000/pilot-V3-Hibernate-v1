...
public abstract class AbstractDaoTest {
    ...
    protected void displayProject(Project project) {
        ...
        displayStudentSet(project.getStudents());
    }

    protected void displayStudentSet(Set<Student> studentSet) {
        logger.info("\t The total associated students={}", studentSet.size());
        int index = 1;
        for (Student student : studentSet) {
            logger.info("No.{} student = {}", index, student);
            displayProjectSet(student.getProjects());
            logger.info("-----------------------------");
            index++;
        }
    }
    ...
    protected void displayMajor(Major major) {
        ...
        displayStudentSet(major.getStudents());
    }
...
//    }
    ...
    protected void displayProjectSet(Set<Project> projectSet) {
